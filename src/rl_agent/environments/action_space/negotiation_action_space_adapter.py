...
from decision_making.src.rl_agent.environments.action_space.common.lateral_mixins import NegotiateLaneChangeMixin
...
class NegotiationActionSpaceAdapter(NegotiateLaneChangeMixin, TerminalVelocityMixin,
                                    TrajectoryBasedActionSpaceAdapter):
    ...
    def __init__(self, action_space_params) -> None:
        ...
        super().__init__(action_space_params,
                         [LateralOffsetTerminalVelocityActionRecipe(*comb)
                          for comb in product(list(action_space_params['LATERAL_DIRECTIONS']),
                                              velocity_grid.array,
                                              action_space_params['AGGRESSIVENESS_LEVELS'])])


class NegotiationActionSpaceAdapterForLaneMerge(NegotiationActionSpaceAdapter):
