...
LOG_MSG_DRIVER_OVERRIDE_RECEIVED = "Received Driver Override Status message with Timestamp: "
LOG_MSG_SCENE_TCD_RECEIVED = "Received SceneTrafficControlDevices message with Timestamp: "
LOG_MSG_LCFTR_RECEIVED = "Received lane_change_for_time_and_route with Timestamp: "
LOG_MSG_CONTROL_STATUS_RECEIVED = "Received Control Status message with Timestamp: "
