...
DEVIATION_TO_SHOULDER_COST = 1.0 * 1e2      # cost of deviation to shoulders (sigm
# oid)
...
BEHAVIORAL_PLANNING_DEFAULT_DESIRED_SPEED = 30/3.6  # TODO - get this value from the map
