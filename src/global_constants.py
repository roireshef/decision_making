...
# [far, medium, close]
GAP_SETTING_HEADWAY = np.array([2.0, 1.5, 1.0])
...
# [far, medium, close]
GAP_SETTING_COMFORT_HDW_MIN = np.array([-0.3, -0.2, -0.1])
GAP_SETTING_COMFORT_HDW_MAX = np.array([0.1, 0.2, 0.3])
...
GAP_SETTING_COMFORT_ZONE_JERK_WEIGHT_MULTIPLIER = 1.2
