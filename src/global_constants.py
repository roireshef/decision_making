...
LOG_MSG_PREDICTION_RECEIVED = "Received Prediction message with Timestamp "
LOG_MSG_PEDAL_POSITION_RECEIVED = "Received PedalPosition message with Timestamp "
LOG_MSG_TURN_SIGNAL_RECEIVED = "Received TurnSignal message with Timestamp "
LOG_MSG_GAP_SETTING_RECEIVED = "Received GapSetting message with Timestamp "
LOG_MSG_ROUTE_PLAN_RECEIVED = "Received RoutePlan message with Timestamp "
LOG_MSG_SET_SPEED_RECEIVED = "Received SetSpeed message with Timestamp "
LOG_MSG_DRIVER_OVERRIDE_RECEIVED = "Received DriverOverride Status message with Timestamp "
LOG_MSG_SCENE_TCD_RECEIVED = "Received SceneTrafficControlDevices message with Timestamp "
LOG_MSG_LCFTR_RECEIVED = "Received LaneChangeForTimeAndRoute message with Timestamp "
LOG_MSG_CONTROL_STATUS_RECEIVED = "Received ControlStatus message with Timestamp "
