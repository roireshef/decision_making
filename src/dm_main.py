...
from decision_making.src.planning.behavioral.filtering.action_spec_filter_bank import FilterByLateralAcceleration, \
...
class DmInitialization:
    ...
    def create_behavioral_planner(map_file: str=DEFAULT_MAP_FILE) -> BehavioralPlanningFacade:
        ...
        action_spec_filtering = ActionSpecFiltering(filters=[FilterByLateralAcceleration('predicates'),
                                                             FilterUnsafeExpectedTrajectory()],
                                                    logger=logger)
