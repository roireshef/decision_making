...
from interface.Rte_Types.python.sub_structures.TsSYS_LaneCoupling import TsSYSLaneCoupling
...
from interface.Rte_Types.python.sub_structures.TsSYS_SceneRoadIntersection import TsSYSSceneRoadIntersection
