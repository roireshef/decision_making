from generation_pubsub.Rte_Types.python.sub_structures.TsSYS_Takeover import TsSYSTakeover
from generation_pubsub.Rte_Types.python.sub_structures.TsSYS_DataTakeover import TsSYSDataTakeover
