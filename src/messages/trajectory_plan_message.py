...
from generation_pubsub.Rte_Types.python.sub_structures.TsSYS_TrajectoryPlan import TsSYSTrajectoryPlan
from generation_pubsub.Rte_Types.python.sub_structures.TsSYS_DataTrajectoryPlan import TsSYSDataTrajectoryPlan
