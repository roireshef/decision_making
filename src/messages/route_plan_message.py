...
from generation_pubsub.Rte_Types.python.sub_structures.TsSYS_RoutePlan import TsSYSRoutePlan
from generation_pubsub.Rte_Types.python.sub_structures.TsSYS_DataRoutePlan import TsSYSDataRoutePlan
from generation_pubsub.Rte_Types.python.sub_structures.TsSYS_RoutePlanLaneSegment import TsSYSRoutePlanLaneSegment
