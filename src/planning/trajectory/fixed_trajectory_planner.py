...
class FixedSamplableTrajectory(SamplableTrajectory):
    ...
    def sample(self, time_points: np.ndarray) -> CartesianExtendedTrajectory:
        ...
        indices_of_closest_time_points_trimmed_To_length = indices_of_closest_time_points[indices_of_closest_time_points
                                                                        < len(self._fixed_trajectory)]

        return self._fixed_trajectory[indices_of_closest_time_points_trimmed_To_length]
