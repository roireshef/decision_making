...
class TrajectoryPlanningFacade(DmModule):
    ...
    def _get_current_state(self) -> State:
        ...
        """
        _, input_state = self.pubsub.get_latest_sample(topic=pubsub_topics.STATE_LCM, timeout=1)
    ...
    def _get_mission_params(self) -> TrajectoryParams:
        ...
        """
        _,input_params = self.pubsub.get_latest_sample(topic=pubsub_topics.TRAJECTORY_PARAMS_LCM, timeout=1)
