    ...
    def deserialize(cls, lcmMsg):
        ...
        return cls(
            np.ndarray(shape=tuple(lcmMsg.points.shape[:lcmMsg.points.num_dimensions])
                       ...
                       , dtype=float)
            , np.ndarray(shape=tuple(lcmMsg.T.shape[:lcmMsg.T.num_dimensions])
                         , buffer=np.array(lcmMsg.T.data)
                         , dtype=float)
            , np.ndarray(shape=tuple(lcmMsg.N.shape[:lcmMsg.N.num_dimensions])
                         , buffer=np.array(lcmMsg.N.data)
                         , dtype=float)
            , np.ndarray(shape=tuple(lcmMsg.k.shape[:lcmMsg.k.num_dimensions])
                         , buffer=np.array(lcmMsg.k.data)
                         , dtype=float)
            , np.ndarray(shape=tuple(lcmMsg.k_tag.shape[:lcmMsg.k_tag.num_dimensions])
