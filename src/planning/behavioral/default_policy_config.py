...
class DefaultPolicyConfig(PolicyConfig):
    def __init__(self, margin_from_road_edge: float = 0.2,
                 prefer_other_lanes_where_blocking_object_distance_less_than: float = 45.0,
                 prefer_other_lanes_if_improvement_is_greater_than: float = 10.0,
                 prefer_any_lane_center_if_blocking_object_distance_greater_than: float = 30.0,
