...
class BehavioralPlanningFacade(DmModule):
    def __init__(self, pubsub: PubSub, logger: Logger, behavioral_planner: BehavioralPlanner, short_time_predictor: Predictor) -> None:
        """
    ...
    def _periodic_action_impl(self) -> None:
        ...
        try:
            ...
            trajectory_params, behavioral_visualization_message = self._planner.plan(state_aligned, navigation_plan)
