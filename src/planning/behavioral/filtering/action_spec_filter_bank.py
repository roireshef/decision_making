...
class TrajectoryBuildingActionSpecFilter(ActionSpecFilter):
    ...
    def build_trajectories(self, action_specs: List[ActionSpec], behavioral_state: BehavioralGridState,
        ...
        for rel_lane, lane_specs in specs_by_rel_lane.items():
            ...
            ftrajectories = TrajectoryBuildingActionSpecFilter.pad_trajectories_beyond_spec(lane_specs, ftrajectories_s,
            ...
            if build_lane_segment_velocities:
                lane_segment_velocity_limits[indices_by_rel_lane[rel_lane]] = TrajectoryBuildingActionSpecFilter.\
...
class FilterForKinematics(TrajectoryBuildingActionSpecFilter):
...
class FilterForLaneSpeedLimits(TrajectoryBuildingActionSpecFilter):
    ...
    def filter(self, action_specs: List[ActionSpec], behavioral_state: BehavioralGridState) -> List[bool]:
        ...
        :return: boolean list per action spec: True if a spec passed the filter
        """
        ctrajectories, lane_segment_velocity_limits = self.build_trajectories(action_specs, behavioral_state,
