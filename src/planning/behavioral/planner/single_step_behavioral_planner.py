...
class SingleStepBehavioralPlanner(CostBasedBehavioralPlanner):
    ...
    def plan(self, state: State, nav_plan: NavigationPlanMsg):
        ...
        #[print('recipe[%d].velocity=%f' % (i, recipe.velocity)) for i, recipe in enumerate(action_recipes) if recipe.action_type.value==1]
        ...
        terminal_behavioral_states = self._generate_terminal_states(state, action_specs, action_recipes,
                                                                    action_specs_mask, self.logger)
