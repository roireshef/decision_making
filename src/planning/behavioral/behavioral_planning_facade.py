...
import numpy as np
import traceback
from common_data.interface.Rte_Types.python.uc_system import UC_SYSTEM_STATE_LCM, UC_SYSTEM_ROUTE_PLAN, \
    UC_SYSTEM_TAKEOVER, \
    UC_SYSTEM_SCENE_STATIC, UC_SYSTEM_TRAJECTORY_PARAMS_LCM, UC_SYSTEM_VISUALIZATION_LCM
    ...
    def _periodic_action_impl(self) -> None:
        ...
        try:
            ...
            trajectory_params, samplable_trajectory, behavioral_visualization_message = \
                self._planner.plan(updated_state, route_plan, route_plan_lane_cost_dict)
