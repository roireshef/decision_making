...
from decision_making.src.global_constants import PREDICTION_HORIZON
...
def test_generateTrajectory_sampleParameters_resultPrecise(original_state_with_sorrounding_objects: State):
    state = original_state_with_sorrounding_objects
    werling_generator = WerlingTrajectoryGenerator()
    ...
    samplable_trajectory = werling_generator.generate_trajectory(timestamp_in_sec=target_obj.timestamp_in_sec,
