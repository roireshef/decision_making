...
def test_predictEgoState_apiTest_returnsEgoStatesList(state_fix, testable_map_api):
...
def test_predictState_apiTest_returnsStatesList(state_fix, testable_map_api):
    predicted_timestamps = np.array([0.0, 0.2, 0.4, 0.6, 0.8])
    test_predictor_mock = TestPredictorMock(map_api=testable_map_api)
