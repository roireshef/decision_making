...
class UpstreamLaneNotFound(Exception):
    pass


class DownstreamLaneNotFound(Exception):
    pass


class NavigationPlanTooShort(Exception):
    pass


class NavigationPlanDoesNotFitMap(Exception):
    pass


class AmbiguousNavigationPlan(Exception):
    pass
