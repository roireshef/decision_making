...
from decision_making.test.planning.utils.optimal_control.quintic_poly_formulas import BinaryReadWrite, s_T_grid, \
    v_T_grid, v_0_grid, a_0_grid, EPS
...
discriminator_file_name = 'dynamics_discriminator_wT_%s_wJ_%s_%dX%dX%d.bin' % (wT_str, wJ_str, v_0_grid.shape[0], a_0_grid.shape[0], 2)
