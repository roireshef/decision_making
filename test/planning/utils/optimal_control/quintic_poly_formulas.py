...
if __name__ == "__main__":
    ...
    s0, v0, a0, ds, vT, aT = symbols('s_0 v_0 a_0 ds_0 v_T a_T')
    ...
    # [c5, c4, c3, c2, c1, c0] = A.inv() * Matrix([s0, v0, a0, ds + vT * (T - Tm), vT, aT])
    [c5, c4, c3, c2, c1, c0] = A.inv() * Matrix([s0, v0, a0, ds + vT * T, vT, aT])
    ...
    temp_delta_s_t = (ds + vT * t - x_t.subs(s0, 0).subs(aT, 0)).simplify()
