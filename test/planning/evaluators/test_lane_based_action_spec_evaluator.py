...
def test_findMinCostAugmentedLane_rightSplitLowerCost(state_with_lane_split_on_right, route_plan_lane_split_on_right, turn_signal):
...
def test_findMinCostAugmentedLane_rightSplitHigherCost(state_with_lane_split_on_right, route_plan_lane_split_on_right, turn_signal):
    behavioral_grid_state = BehavioralGridState.create_from_state(state_with_lane_split_on_right, route_plan_lane_split_on_right,
                                                                  turn_signal, None)
    evaluator = AugmentedLaneActionSpecEvaluator(None)
...
def test_findMinCostAugmentedLane_leftSplitLowerCost(state_with_lane_split_on_left, route_plan_lane_split_on_left, turn_signal):
...
def test_findMinCostAugmentedLane_leftSplitHigherCost(state_with_lane_split_on_left, route_plan_lane_split_on_left, turn_signal):
    behavioral_grid_state = BehavioralGridState.create_from_state(state_with_lane_split_on_left,
                                                                  route_plan_lane_split_on_left, turn_signal, None)
    evaluator = AugmentedLaneActionSpecEvaluator(None)
