...
from decision_making.test.planning.scenarios.mock_state_module_with_keyboard import StateModuleMockWithKeyboard
...
class DmInitialization:
    ...
    @staticmethod
    def create_state_module(state) -> StateModule:
        ...
        """
        state_module = StateModuleMockWithKeyboard(dds, logger, state)
        return state_module
