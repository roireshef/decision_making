...
def test_optimalControlUtils_validPolynomZeroToZero_returnsTrue():
    ...
    assert OptimalControlUtils.QuinticPoly1D.is_acceleration_in_limits(pos_poly, 1.3, np.array([-2, 2]))
...
def test_optimalControlUtils_invalidPolynomZeroToZero_returnsFalse():
    ...
    assert not OptimalControlUtils.QuinticPoly1D.is_acceleration_in_limits(pos_poly, 1.3, np.array([-1, 1]))
