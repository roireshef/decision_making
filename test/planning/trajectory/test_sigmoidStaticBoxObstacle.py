...
from decision_making.src.state.state import ObjectSize, NewDynamicObject
...
def test_computeCost_threeSRoutesOneObstacle_validScore():
    ...
    obj = NewDynamicObject.create_from_cartesian_state(None, None, [pose[0], pose[1], pose[2], 1, 0, 0],
