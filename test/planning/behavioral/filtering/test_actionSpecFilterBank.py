...
@patch('decision_making.src.planning.behavioral.action_space.distance_facing_action_space.SPECIFICATION_HEADWAY', 1.5)
@patch.multiple('decision_making.src.planning.behavioral.action_space.distance_facing_action_space',BP_ACTION_T_LIMITS=np.array([0, 15]))
@patch.multiple('decision_making.src.planning.behavioral.action_space.distance_facing_action_space',BP_JERK_S_JERK_D_TIME_WEIGHTS=np.array([
    [12, 0.15, 0.1],
    [2, 0.15, 0.1],
    [0.01, 0.15, 0.1]
]))
