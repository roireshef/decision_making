...
@patch('decision_making.src.planning.behavioral.filtering.action_spec_filter_bank.FilterForLaneSpeedLimits._get_minimal_trajectory_speed', lambda *args : 40 / 3.6)
