...
from decision_making.test.planning.behavioral.behavioral_state_fixtures import \
    ...
    behavioral_grid_state_with_objects_for_safety, \
    state_with_objects_for_safety, \
    ...
    route_plan_1_2, behavioral_grid_state_with_left_lane_ending, state_with_left_lane_ending, follow_left_lane_recipes
...
def test_StaticTrafficFlowControlFilter_filtersWhenTrafficFlowControlexits(behavioral_grid_state_with_traffic_control,
    ...
    action_specs = [ActionSpec(t, t, v, s, d,
...
def test_BeyondSpecSpeedLimitFilter_SlowLaneAhead(behavioral_grid_state_with_traffic_control, scene_static_pg_split):
    ...
    action_specs = [
        ActionSpec(t, t, v, s, d, ActionRecipe(RelativeLane.SAME_LANE, ActionType.FOLLOW_LANE, AggressivenessLevel.CALM))]
    ftrajectories, ctrajectories = ActionSpecFiltering._build_trajectories(action_specs, behavioral_grid_state_with_traffic_control)
    actual = filter.filter(action_specs=action_specs, behavioral_state=behavioral_grid_state_with_traffic_control,
                           ftrajectories=ftrajectories, ctrajectories=ctrajectories)
    expected = [False]
...
def test_filter_staticActionsWithLeadingVehicle_filterResultsMatchExpected(
        behavioral_grid_state_with_objects_for_safety,
        follow_left_lane_recipes: List[StaticActionRecipe], scene_static_pg_split):
    """
    ...
    action_specs = static_action_space.specify_goals(follow_left_lane_recipes,
                                                     behavioral_grid_state_with_objects_for_safety)
...
def test_BeyondSpecGffFilter_FilteredIfCloseToEndOfPartialGff(behavioral_grid_state_with_left_lane_ending,
    ...
    action_specs = [
        ActionSpec(t, t, v, s, d, ActionRecipe(RelativeLane.SAME_LANE, ActionType.FOLLOW_LANE, AggressivenessLevel.CALM)),
        ActionSpec(t, t, v, s, d, ActionRecipe(RelativeLane.LEFT_LANE, ActionType.FOLLOW_LANE, AggressivenessLevel.CALM))]
