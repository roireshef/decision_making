...
from decision_making.test.messages.scene_static_fixture import lane_split_scene_static, scene_static_short_testable
...
def test_createMirrorObjects_laneSplit_carInOverlap(lane_split_scene_static: SceneStatic):
    """
    Validate that mirror object is correctly placed in overlapping lane
    """
    SceneStaticModel.get_instance().set_scene_static(lane_split_scene_static)
