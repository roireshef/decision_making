...
def test_overloadDynamicObject_createsCorrectPseudoObjects(intersection_state_with_sorrounding_objects):
    ...
    vehicles_on_intersection = [DynamicObject(obj_id=object_on_210.obj_id, timestamp= object_on_210.timestamp,
                                              ...
                                              map_state_on_host_lane=object_on_210.map_state_on_host_lane,
                                ...
                                DynamicObject(obj_id=object_on_211.obj_id, timestamp= object_on_211.timestamp,
                                              ...
                                              map_state_on_host_lane=object_on_211.map_state_on_host_lane,
...
def test_lazySetMapStates_calculateAccurateFstate(intersection_state_with_sorrounding_objects):
    overloaded_objects = BehavioralGridState._overload_dynamic_objects(dynamic_objects=intersection_state_with_sorrounding_objects.dynamic_objects)
    object_on_210 = intersection_state_with_sorrounding_objects.dynamic_objects[2]
    object_on_211 = intersection_state_with_sorrounding_objects.dynamic_objects[4]
    ...
    fstate210_on_211 = extended_lane_frames[RelativeLane.SAME_LANE].cstate_to_fstate(object_on_210.cartesian_state)
    fstate211_on_210 = extended_lane_frames[RelativeLane.RIGHT_LANE].cstate_to_fstate(object_on_211.cartesian_state)
...
def test_createFromState_correctProjectionOfIntersectionVehicles(intersection_state_with_sorrounding_objects):
    ...
    for cell in product(RelativeLane, RelativeLongitudinalPosition):
        print(behavioral_grid_state.road_occupancy_grid[cell])
