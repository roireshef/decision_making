...
def test_createSafeActions():
    ego_fstate = np.array([100, 18.485821280998735, 1.])
    ego_len = 5
    actor1 = LaneMergeActorState(-46.68407334, 25, ego_len)
    actor2 = LaneMergeActorState(37.58871376, 25, ego_len)
    actor3 = LaneMergeActorState(79.68407334, 25, ego_len)
    actors = [actor1, actor2, actor3]
    merge_from_s = 0
    red_line_s = 183.748177641319444
