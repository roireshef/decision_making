...
from decision_making.src.global_constants import STATE_MODULE_NAME_FOR_LOGGING, VELOCITY_MINIMAL_THRESHOLD, \
    PG_SPLIT_PICKLE_FILE_NAME, TESTABLE_MAP_PICKLE_FILE_NAME
...
from decision_making.test.messages.static_scene_fixture import scene_static, scene_static_testable
