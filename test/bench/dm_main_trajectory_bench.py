...
class DmMockInitialization:
    ...
    # The purpose here is to continuousely publish localization (as long as it is available from the IMU) without
    # waiting for a dynamic object update.
...
def main(fixed_trajectory_file: str = None, map_file: str = DEFAULT_MAP_FILE, nav_plan: NavigationPlanMsg = NAVIGATION_PLAN_MILFORD):
    """
